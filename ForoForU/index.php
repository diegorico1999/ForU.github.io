...
<head>
	...
	<meta name="keywords" content="foro, ForU, crear, tema, comentario, conversación, comentar, diego alejandro rico">
	<meta name="description" content="ForU es el foro perfecto para compartir tus ideas, o hacer preguntas con total libertad, y por supuesto: GRATIS.">
	...
	<section id="banner" class="formYFirstInfo">
		<div class="contGnral formYFirstInfo">
			...
			<article class="contenedorFormulario formconj">
					<div id="regisForm">
						<p>¡Regístrate gratis a <strong>ForU</strong> si aún no lo has hecho!</p>
					</div>
