...
<head>
	<meta charset="UTF-8">
	<title>ForU - Darse de alta</title>	
	<script src="https://ajax.googleapis.com/ajax/libs/jquery/3.3.1/jquery.min.js"></script>	
	<!--<script src="../js/script.js"></script>-->
	<link href="https://fonts.googleapis.com/css?family=Roboto" rel="stylesheet">
	<link href="https://fonts.googleapis.com/css?family=Raleway" rel="stylesheet">
	<link rel="stylesheet" href="../style/estilos.css">
	<meta name="keywords" content="foro, ForU, inscribirse, dar de alta, login, Diego Alejandro Rico">
	<meta name="description" content="Página de inscripción de ForU, no pierdas un minuto más sin registrarte en el foro.">
	...
	<section id="banner" class="inscribirse">
		<div class="contGnral formunico">
			<article class="contenedorFormulario formunico">
				<h2 class="formins">¡Accede a ForU!</h2>
